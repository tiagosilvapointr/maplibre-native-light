...
MLN_LAYER_BACKGROUND_GENERATED_DARWIN_STYLE_SOURCE = [
    "src/MLNBackgroundStyleLayer.mm",
]

MLN_LAYER_CIRCLE_GENERATED_DARWIN_STYLE_SOURCE = [
    "src/MLNCircleStyleLayer.mm",
]

MLN_LAYER_COLOR_RELIEF_GENERATED_DARWIN_STYLE_SOURCE = [
    "src/MLNColorReliefStyleLayer.mm",
]

MLN_LAYER_FILL_GENERATED_DARWIN_STYLE_SOURCE = [
    "src/MLNFillStyleLayer.mm",
]

MLN_LAYER_FILL_EXTRUSION_GENERATED_DARWIN_STYLE_SOURCE = [
    "src/MLNFillExtrusionStyleLayer.mm",
]

MLN_LAYER_HEATMAP_GENERATED_DARWIN_STYLE_SOURCE = [
    "src/MLNHeatmapStyleLayer.mm",
]

MLN_LAYER_HILLSHADE_GENERATED_DARWIN_STYLE_SOURCE = [
    "src/MLNHillshadeStyleLayer.mm",
]

MLN_LAYER_LINE_GENERATED_DARWIN_STYLE_SOURCE = [
    "src/MLNLineStyleLayer.mm",
]

MLN_LAYER_RASTER_GENERATED_DARWIN_STYLE_SOURCE = [
    "src/MLNRasterStyleLayer.mm",
]

MLN_LAYER_SYMBOL_GENERATED_DARWIN_STYLE_SOURCE = [
    "src/MLNSymbolStyleLayer.mm",
]

MLN_GENERATED_DARWIN_STYLE_SOURCE_COMMON = [
    "src/MLNLight.mm",
]
...
MLN_LAYER_BACKGROUND_GENERATED_DARWIN_STYLE_PUBLIC_HEADERS = [
    "src/MLNBackgroundStyleLayer.h",
]

MLN_LAYER_CIRCLE_GENERATED_DARWIN_STYLE_PUBLIC_HEADERS = [
    "src/MLNCircleStyleLayer.h",
]

MLN_LAYER_COLOR_RELIEF_GENERATED_DARWIN_STYLE_PUBLIC_HEADERS = [
    "src/MLNColorReliefStyleLayer.h",
]

MLN_LAYER_FILL_GENERATED_DARWIN_STYLE_PUBLIC_HEADERS = [
    "src/MLNFillStyleLayer.h",
]

MLN_LAYER_FILL_EXTRUSION_GENERATED_DARWIN_STYLE_PUBLIC_HEADERS = [
    "src/MLNFillExtrusionStyleLayer.h",
]

MLN_LAYER_HEATMAP_GENERATED_DARWIN_STYLE_PUBLIC_HEADERS = [
    "src/MLNHeatmapStyleLayer.h",
]

MLN_LAYER_HILLSHADE_GENERATED_DARWIN_STYLE_PUBLIC_HEADERS = [
    "src/MLNHillshadeStyleLayer.h",
]

MLN_LAYER_LINE_GENERATED_DARWIN_STYLE_PUBLIC_HEADERS = [
    "src/MLNLineStyleLayer.h",
]

MLN_LAYER_RASTER_GENERATED_DARWIN_STYLE_PUBLIC_HEADERS = [
    "src/MLNRasterStyleLayer.h",
]

MLN_LAYER_SYMBOL_GENERATED_DARWIN_STYLE_PUBLIC_HEADERS = [
    "src/MLNSymbolStyleLayer.h",
]

MLN_GENERATED_DARWIN_STYLE_PUBLIC_HEADERS_COMMON = [
    "src/MLNLight.h",
]
...
MLN_LAYER_BACKGROUND_GENERATED_DARWIN_STYLE_HEADERS = [
    "src/MLNBackgroundStyleLayer_Private.h",
] + MLN_LAYER_BACKGROUND_GENERATED_DARWIN_STYLE_PUBLIC_HEADERS

MLN_LAYER_CIRCLE_GENERATED_DARWIN_STYLE_HEADERS = [
    "src/MLNCircleStyleLayer_Private.h",
] + MLN_LAYER_CIRCLE_GENERATED_DARWIN_STYLE_PUBLIC_HEADERS

MLN_LAYER_COLOR_RELIEF_GENERATED_DARWIN_STYLE_HEADERS = [
    "src/MLNColorReliefStyleLayer_Private.h",
] + MLN_LAYER_COLOR_RELIEF_GENERATED_DARWIN_STYLE_PUBLIC_HEADERS

MLN_LAYER_FILL_GENERATED_DARWIN_STYLE_HEADERS = [
    "src/MLNFillStyleLayer_Private.h",
] + MLN_LAYER_FILL_GENERATED_DARWIN_STYLE_PUBLIC_HEADERS

MLN_LAYER_FILL_EXTRUSION_GENERATED_DARWIN_STYLE_HEADERS = [
    "src/MLNFillExtrusionStyleLayer_Private.h",
] + MLN_LAYER_FILL_EXTRUSION_GENERATED_DARWIN_STYLE_PUBLIC_HEADERS

MLN_LAYER_HEATMAP_GENERATED_DARWIN_STYLE_HEADERS = [
    "src/MLNHeatmapStyleLayer_Private.h",
] + MLN_LAYER_HEATMAP_GENERATED_DARWIN_STYLE_PUBLIC_HEADERS

MLN_LAYER_HILLSHADE_GENERATED_DARWIN_STYLE_HEADERS = [
    "src/MLNHillshadeStyleLayer_Private.h",
] + MLN_LAYER_HILLSHADE_GENERATED_DARWIN_STYLE_PUBLIC_HEADERS

MLN_LAYER_LINE_GENERATED_DARWIN_STYLE_HEADERS = [
    "src/MLNLineStyleLayer_Private.h",
] + MLN_LAYER_LINE_GENERATED_DARWIN_STYLE_PUBLIC_HEADERS

MLN_LAYER_RASTER_GENERATED_DARWIN_STYLE_HEADERS = [
    "src/MLNRasterStyleLayer_Private.h",
] + MLN_LAYER_RASTER_GENERATED_DARWIN_STYLE_PUBLIC_HEADERS

MLN_LAYER_SYMBOL_GENERATED_DARWIN_STYLE_HEADERS = [
    "src/MLNSymbolStyleLayer_Private.h",
] + MLN_LAYER_SYMBOL_GENERATED_DARWIN_STYLE_PUBLIC_HEADERS

MLN_GENERATED_DARWIN_STYLE_HEADERS_COMMON = MLN_GENERATED_DARWIN_STYLE_PUBLIC_HEADERS_COMMON
...
MLN_LAYER_CUSTOM_DARWIN_OBJC_HEADERS = [
    "src/MLNCustomStyleLayer.h",
]

MLN_LAYER_CUSTOM_DRAWABLE_DARWIN_OBJC_HEADERS = [
    "src/MLNCustomDrawableStyleLayer.h",
]

MLN_LAYER_PLUGIN_DARWIN_OBJC_HEADERS = [
    "src/MLNPluginLayer.h",
    "src/MLNPluginStyleLayer.h",
]

MLN_LAYER_RASTER_DARWIN_OBJC_HEADERS = [
    "src/MLNImageSource.h",
]

MLN_LAYER_RASTER_DEM_DARWIN_OBJC_HEADERS = [
    "src/MLNRasterDEMSource.h",
]

MLN_LAYER_RASTER_SHARED_DARWIN_OBJC_HEADERS = [
    "src/MLNRasterTileSource.h",
]

MLN_DARWIN_OBJC_LAYER_HEADERS = (
    MLN_LAYER_CUSTOM_DARWIN_OBJC_HEADERS +
    MLN_LAYER_CUSTOM_DRAWABLE_DARWIN_OBJC_HEADERS +
    MLN_LAYER_PLUGIN_DARWIN_OBJC_HEADERS +
    MLN_LAYER_RASTER_DARWIN_OBJC_HEADERS +
...
MLN_DARWIN_OBJC_COMMON_HEADERS = _without(MLN_DARWIN_OBJC_HEADERS, MLN_DARWIN_OBJC_LAYER_HEADERS)
...
MLN_LAYER_CUSTOM_DARWIN_PRIVATE_HEADERS = [
    "src/MLNCustomStyleLayer_Private.h",
]

MLN_LAYER_PLUGIN_DARWIN_PRIVATE_HEADERS = [
    "src/MLNPluginStyleLayer_Private.h",
]

MLN_LAYER_RASTER_SHARED_DARWIN_PRIVATE_HEADERS = [
    "src/MLNRasterTileSource_Private.h",
]

MLN_DARWIN_LAYER_PRIVATE_HEADERS = (
    MLN_LAYER_CUSTOM_DARWIN_PRIVATE_HEADERS +
    MLN_LAYER_PLUGIN_DARWIN_PRIVATE_HEADERS +
    MLN_LAYER_RASTER_SHARED_DARWIN_PRIVATE_HEADERS
)

MLN_DARWIN_COMMON_PRIVATE_HEADERS = _without(MLN_DARWIN_PRIVATE_HEADERS, MLN_DARWIN_LAYER_PRIVATE_HEADERS)
...
MLN_LAYER_CUSTOM_DARWIN_PUBLIC_OBJCPP_SOURCE = [
    "src/MLNCustomStyleLayer.mm",
]

MLN_LAYER_PLUGIN_DARWIN_PUBLIC_OBJCPP_SOURCE = [
    "src/MLNPluginLayer.mm",
    "src/MLNPluginStyleLayer.mm",
]

MLN_LAYER_RASTER_DARWIN_PUBLIC_OBJCPP_SOURCE = [
    "src/MLNImageSource.mm",
]

MLN_LAYER_RASTER_DEM_DARWIN_PUBLIC_OBJCPP_SOURCE = [
    "src/MLNRasterDEMSource.mm",
]

MLN_LAYER_RASTER_SHARED_DARWIN_PUBLIC_OBJCPP_SOURCE = [
    "src/MLNRasterTileSource.mm",
]

MLN_DARWIN_PUBLIC_OBJCPP_LAYER_SOURCE = (
    MLN_LAYER_CUSTOM_DARWIN_PUBLIC_OBJCPP_SOURCE +
    MLN_LAYER_PLUGIN_DARWIN_PUBLIC_OBJCPP_SOURCE +
    MLN_LAYER_RASTER_DARWIN_PUBLIC_OBJCPP_SOURCE +
    MLN_LAYER_RASTER_DEM_DARWIN_PUBLIC_OBJCPP_SOURCE +
...
MLN_DARWIN_PUBLIC_OBJCPP_COMMON_SOURCE = _without(MLN_DARWIN_PUBLIC_OBJCPP_SOURCE, MLN_DARWIN_PUBLIC_OBJCPP_LAYER_SOURCE)
