...
// The iOS/tvOS Simulator's Metal.framework does not export some of the new
// 26.0 SDK constants (e.g. MTLIOErrorDomain, MTLTensorDomain), so weak_import
// references generated by the SDK 26 branch below fail to link on simulator.
// Fall back to the runtime dlsym lookup path for simulator builds.
